...
import com.huwo.haikou.gateway.domain.TableEnum;
...
public class CanalConfig implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            ...
            //TODO 订阅数据库
            canalConnector.subscribe("haikou2022.*");
                        ...
                        for (CanalEntry.RowData rowData : rowDataList) {
                            ...
                            for (CanalEntry.Column column : afterColumnsList) {
                                if(!StringUtils.isEmpty(column.getValue())){
                                    ...
                                    afterData.put("ipcType", TableEnum.getIpcTypeByTableName(tableName));
                                }
                            }



                            if(eventType.toString().equalsIgnoreCase("INSERT")){
                                //数据打印
                                System.out.println("Table:" + tableName + ",EventType:" + eventType + ",After:" + afterData);
